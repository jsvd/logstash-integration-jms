## 0.1.0
- First release of Logstash Integration JMS

# Logstash Input JMS Changelog (before integration merger)
...
# Logstash Output JMS Changelog (before integration merger)
